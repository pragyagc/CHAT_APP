...
public class ChatHub : Hub
{
    ...
    UserManager<User> userManager, IOnlineUserService onlineUserService)
    {
    ...
    public override async Task OnConnectedAsync()
    {
        ...
        _onlineUserService.Add(user.Id, Context.ConnectionId);
    ...
    public override async Task OnDisconnectedAsync(Exception? exception)
    {
        ...
        if (user != null)
        {
            _onlineUserService.Remove(Context.ConnectionId);
    ...
    {
        return _onlineUserService.IsOnline(userId);
    }
